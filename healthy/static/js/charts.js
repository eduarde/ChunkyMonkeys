...
var lineChartData = {
  ...
  datasets: [{
    ...
    data: [6, 6.4, 6.3, 6.1, 6, 6.2]
  },
    {
    label: "Minimal",
    fillColor: "rgba(41, 138, 105, 0.5)",
    strokeColor: "none",
    pointColor: "rgba(73, 194, 125, 0.9)",
    pointStrokeColor: "rgba(41, 128, 185, 0)",
    pointHighlightFill: "rgba(73, 194, 125, 0.9)",
    pointHighlightStroke: "rgba(41, 128, 185, 0)",
    data: [5,5.1,5.2,5.2,5.2,5.3]}
      ]
};
